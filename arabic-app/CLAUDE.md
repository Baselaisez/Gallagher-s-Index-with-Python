...
tools/
  ...
  smoke_test.js         88 browser checks over file:// (Playwright)
...
**The Ism engine keeps the Root Finder's oath: table before rule.**
...
**The Analyzer reads signals, it does not claim i'rab.** `class
